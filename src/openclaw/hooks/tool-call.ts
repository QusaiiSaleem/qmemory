/**
 * after_tool_call + tool_result_persist hooks
 *
 * after_tool_call: logs every tool call to the ledger
 * tool_result_persist: compresses large tool results before storage
 */
